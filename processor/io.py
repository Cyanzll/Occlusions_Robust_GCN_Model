...
class IO():
    ...
    def load_arg(self, argv=None):
        ...
        # load arg form config file：从config下的文件（yaml）加载参数
        p = parser.parse_args(argv)
        # p.config='config/st_gcn/ntu-x*/train.yaml 就是对应的文件名
    ...
    def init_environment(self):
        ...
        if self.arg.use_gpu:
            ...
            # 此处打印
            print("yaml config: "+str(self.arg.device))
            print("visible gpu: " + str(gpus))
